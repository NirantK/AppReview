"""
Code is courtesy [PritishSingla] from [Github](https://github.com/Pritishsingla/nbsvm_sklearn/blob/master/nbsvm/nbsvm.py)
This is Fair Usage under the MIT License of the original code
"""
